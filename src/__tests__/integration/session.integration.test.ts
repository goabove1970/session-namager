...
describe("Session Management Integration Tests", () => {
  ...
  describe("POST /session - Init Session", () => {
    it(
      "should successfully create a new session with userId and sessionData",
      async () => {
    ...
    it(
      "should return error when creating session without userId",
      async () => {
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
          .send({
  ...
  describe("POST /session - Extend Session", () => {
    ...
    it(
      "should successfully extend an active session",
      async () => {
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
          .send({
    ...
    it(
      "should return error when extending non-existent session",
      async () => {
    ...
    it(
      "should return error when extending expired session",
      async () => {
  ...
  describe("POST /session - Validate Session", () => {
    ...
    it(
      "should return ACTIVE state for a valid active session",
      async () => {
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
          .send({
    ...
    it(
      "should return EXPIRED state for a terminated session",
      async () => {
    ...
    it(
      "should return EXPIRED state for non-existent session",
      async () => {
        const nonExistentSessionId = "non-existent-session-id-12345";
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
  ...
  describe("POST /session - Terminate Session", () => {
    ...
    it(
      "should successfully terminate an active session",
      async () => {
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
          .send({
    ...
    it(
      "should handle termination of non-existent session gracefully",
      async () => {
        const nonExistentSessionId = "non-existent-session-id-12345";
        const response = await request(TEST_BASE_URL)
          .post(BASE_URL)
    ...
    it(
      "should handle termination of already expired session gracefully",
      async () => {
        // Terminate the session first
        await request(TEST_BASE_URL)
          .post(BASE_URL)
  ...
  describe("GET /session - Alternative HTTP Method", () => {
    it(
      "should accept GET requests with same functionality",
      async () => {
        const response = await request(TEST_BASE_URL)
          .get(BASE_URL)
          .send({
  ...
  describe("Session Lifecycle - Complete Flow", () => {
    it(
      "should handle complete session lifecycle: init -> extend -> validate -> terminate",
      async () => {
        // 1. Init
        const initResponse = await request(TEST_BASE_URL)
          .post(BASE_URL)
